        ...
        if(!regAdrQuota.test(reply)) {
          if(regNoConnectionLinked.test(reply))
            this.noConnectionLinked();
              ...
              var regServerUnavailable = /ne sont pas disponibles|problËme technique|technical problem|technisch probleem|Une erreur s'est produite|An error has occurred/;
