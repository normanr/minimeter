...
Minimeter.Karneval = function(username, password) {
...
Minimeter["Karneval"].prototype = new Minimeter.Monitor();

Minimeter["Karneval"].prototype.callback = function(step, reply) {
  if(this.aborted()){
    return;
  }
