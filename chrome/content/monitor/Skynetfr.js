function Skynetfr(username, password) {
    this.username = username;
    this.password = password;
    this.image = "skynetfr.png"; // does not belong in class
    this.name = "Skynet ADSL";
    this.url = "https://e-care.skynet.be/index.cfm?function=connection.getVolume"
}

Skynetfr.prototype = new Monitor();

Skynetfr.prototype.callback = function(step, reply) {
