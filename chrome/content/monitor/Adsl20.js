...
Minimeter["Adsl20"].prototype = new Minimeter.Monitor();

Minimeter["Adsl20"].prototype.callback = function(step, reply) {
  if(this.aborted()){
    return;
  }
  ...
  switch(step)
  {
    default:
    case 1:
      Minimeter.http_get("http://myaccount.adsl20.be/Beheer/index.aspx", this, 2);
      break;
    ...
    case 2:
      ...
      Minimeter.http_post('http://myaccount.adsl20.be/Beheer/index.aspx', postdata,this, 3);
      break;
