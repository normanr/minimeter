...
Minimeter.Mobistariew = function(username, password) {
...
Minimeter["Mobistariew"].prototype = new Minimeter.Monitor();

Minimeter["Mobistariew"].prototype.callback = function(step, reply) {
    if(this.aborted()){
      return;
    }
      ...
      case 2:
        ...
        Minimeter.http_get("https://partners.mobistar.be/selfcare/?lg=fr", this, 3);
        break;
      ...
      case 3:
        ...
        Minimeter.http_get("http://partners.mobistar.be/conso-iew-logged/index.cfm?lg=FR", this, 4);
        break;
      ...
      case 4:
        ...
        var mb = " " + Minimeter.getunitPrefix("MB"); // Unit as selected in options and locale
        ...
        if(nbDataWhenRoaming != "0.00") {
          extraMsgRoamingInfo = "\n       "+nbDataWhenRoaming +mb +" "+Minimeter.getString("info.MIEWInRoaming");
          extraPrixMsgRoamingInfo = "("+Minimeter.getString("info.plusRoamingDataInPrice")+")";
        }
        ...
        this.extraMessage = "       "+ nbDayConnected + " "+Minimeter.getString("info.MIEWNbDayConnect")+" "+stringAtReturnIfIEW+" " + extraMsgRoamingInfo + extraPrixMsgRoamingInfo;
